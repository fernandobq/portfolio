...
<template>
    <div class="max-w-1440 grid grid-cols-12 mx-auto gap-x-8 py-5 px-10 lg:px-20">
        ...
        >
            <RouterLink
                class="xl:text-2xl xl:ml-7 xl:py-4 xl:px-8 
                lg:text-xl lg:ml-5 lg:py-3 lg:px-6 
                md:text-l md:ml-3 md:py-2 md:px-4
                h-fit hover:text-white normal-transition rounded-md"
